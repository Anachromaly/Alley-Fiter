...
//		Player p1 = Integrator.getPlayer1();
//		Player p2 = Integrator.getPlayer2();
//		
//		if(p1.getHitbox().intersects(hitbox) && id == ItemID.Robot) {
//			xSpeed = 0;
//			ySpeed = 0;
//			x = p1.getHitbox().getWidth() + p1.getWidth();
//			switch(direction) {
//			case -1 :
//				x = p1.getHitbox().getWidth() + p1.getWidth();
//			}
//		}
//		
//		if(id == ItemID.Dino && p2.getHitbox().intersects(hitbox)) {
//			xSpeed = 0;
//			ySpeed = 0;
//			x = p2.getHitbox().getWidth() + p2.getWidth();
//		}
